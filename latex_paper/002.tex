...
% 压缩间距设置
\setlength{\abovecaptionskip}{5pt}   % 图表标题上方间距
\setlength{\belowcaptionskip}{2pt}   % 图表标题下方间距
\setlength{\floatsep}{12pt}          % 浮动体之间的间距
\setlength{\textfloatsep}{12pt}      % 浮动体与正文间距
\setlength{\intextsep}{10pt}         % 行内浮动体间距
...
\begin{figure}[htbp]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.05\textwidth]{文献综述示意图.pdf}}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{our_work.pdf}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.475\textwidth]{电路示意图.pdf}
...
\begin{figure}[htbp]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.0\textwidth]{model1/模型一伪代码示意图.pdf}}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{model1/model1_validation_premium.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{model2/model2_temperature_effect.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{model2/model2_integration_validation.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.85\textwidth]{model3/fig7_circadian_modulation.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.95\textwidth]{model3/模型III 伪代码示意图.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{model4&sensitivity_analysis/Model IV 示意图.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.90\textwidth]{model4&sensitivity_analysis/sensitivity_combined.pdf}
